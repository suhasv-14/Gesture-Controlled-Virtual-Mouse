...
# Executes commands according to detected gestures 74 usages
class Controller:
    """
    ...
    pinch_tresh : double
        step size for the automation of the ocale.
    """
...
print("AI Powered Virtual Mouse is Recognised")
